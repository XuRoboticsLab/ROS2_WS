...
tmux send-keys -t "$SESSION:4" "sudo /home/xuroboticslab/miniforge3/envs/panthera/bin/python $WS_DIR/code/foot_pedal/main.py" Enter

# Focus first window
tmux select-window -t "$SESSION:0"

echo "Attaching to session '$SESSION'..."
echo "Detach with: Ctrl+b d | Switch windows: Ctrl+b [0-3] or Ctrl+b n/p"
